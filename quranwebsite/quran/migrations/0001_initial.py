    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language1', models.TextField(max_length=1500, null=True, verbose_name='ترجمه')),
                ('language2', models.TextField(max_length=1500, null=True, verbose_name='ترجمه')),
                ('language3', models.TextField(max_length=1500, null=True, verbose_name='ترجمه')),
                ('language4', models.TextField(max_length=1500, null=True, verbose_name='ترجمه')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('header_logo', models.ImageField(upload_to='header-logo/', verbose_name='لوگو')),
                ...
                ('header_photo', models.ImageField(upload_to='header_photo', verbose_name='تصویر')),
