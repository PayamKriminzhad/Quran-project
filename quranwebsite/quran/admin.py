...
from .models import Settings_main, Messages_contact, Aya, Hadis, Messages_footer
...
class Messages_footerAdmin(admin.ModelAdmin):
    list_display = ['name']
...
admin.site.register(Messages_footer, Messages_footerAdmin )
